...
from sc2_rl_agent.starcraftenv_test.summarize.glm2_test.L2_summarize import L2_summary
from sc2_rl_agent.starcraftenv_test.log_data_processing.get_decisions import *
...
class Glm2Agent:
    ...
    def __init__(self, model_name, api_key, api_base, system_prompt, example_prompt, temperature, args,
        ...
        self.base_save_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'log', 'glm2_log')
