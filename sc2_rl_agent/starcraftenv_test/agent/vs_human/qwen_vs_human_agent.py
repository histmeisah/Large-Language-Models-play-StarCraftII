...
from sc2_rl_agent.starcraftenv_test.summarize.llama2_test.L2_summarize import L2_summary
...
class Qwen_vs_Human_Agent:
    ...
    def __init__(self, system_prompt, example_prompt, args,
                 action_description,
        ...
        self.base_save_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../..', 'log', "vshuman", 'qwen_log')
