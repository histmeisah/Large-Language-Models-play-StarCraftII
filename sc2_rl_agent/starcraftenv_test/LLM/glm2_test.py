...
class ChatBot_SingleTurn:
    ...
    def __init__(self, model_name, api_key, api_base, system_prompt, example_prompt,temperature,port=4444, host='172.18.116.172'):
        """
    ...
    def query(self, user_input, max_retries=5):
        ...
        # 构造instruction部分
        instruction = f"{self.system_prompt}#×××*{self.example[0]}#×××*{self.example[1]}"
