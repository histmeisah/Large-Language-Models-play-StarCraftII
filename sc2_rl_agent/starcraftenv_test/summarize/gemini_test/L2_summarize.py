from sc2_rl_agent.starcraftenv_test.LLM.gemini_test import GeminiChatBot as ChatBot_SingleTurn
...
class L2_summary:
    ...
    def __init__(self, LLMapi_base, LLMapi_key, model_name, temperature, system_prompt, example_prompt, chunk_window,
        ...
        self.chatbot = ChatBot_SingleTurn(api_base=self.api_base, api_key=self.api_key, model_name=self.model_name,
                                          ...
                                          example_prompt=self.example_prompt, game_folder=game_folder)
